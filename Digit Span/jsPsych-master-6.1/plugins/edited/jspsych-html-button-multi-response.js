...
jsPsych.plugins["html-button-multi-response"] = (function() {
  ...
  plugin.info = {
    ...
    parameters: {
      ...
      submit_btn: {
        type: jsPsych.plugins.parameterType.STRING,
        pretty_name: 'Submit Button',
        default: '',
        description: 'The html of a submit button. Pressing this ends the trial.'
      },
      prompt: {
        type: jsPsych.plugins.parameterType.STRING,
        pretty_name: 'Prompt',
  ...
  plugin.trial = function(display_element, trial) {
    ...
    if (trial.submit_btn !== "") {
      display_element.insertAdjacentHTML('beforeend', '<div style = "margin-top: 20px;" class = "jspsych-submit-btn">'+trial.submit_btn+'</div>');

      display_element.querySelector('#submit-btn').addEventListener('click', function(){
        end_trial()
      });
    }
    ...
    function end_trial() {
      ...
      var trial_data = {
        ...
        "button_pressed": JSON.stringify(response.button)
      };
